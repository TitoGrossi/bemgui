...
from bemgui.view.auxiliarywidgets import disabableLineEdit, disabableCheckBox
...
class Ui_setDisplacementCondition(object):
    ...
    def retranslateUi(self, setDisplacementCondition):
        ...
        self.checkBox_apply_same_all.setText(_translate("setDisplacementCondition", "Repeat for middle point"))
